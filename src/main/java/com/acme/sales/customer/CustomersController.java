...
public class CustomersController {
	...
	@GetMapping("{id}") //this represents variable that will be read from URL.
	public ResponseEntity<Customer> GetById(@PathVariable int id) { //PathVariable actually allows the reading of the URL.
	...
	@PostMapping
	public ResponseEntity<Customer> Insert(@RequestBody Customer customer) { //RequestBody says what is needed will be 
